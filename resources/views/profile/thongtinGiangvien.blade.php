                    ...
                    <form action="{{ route('profilegiangvien.update') }}" method="POST">
                        ...
                        <div class="info-common">
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input input--not-edit" type="text" id="maGV" name="MaGV" value="{{ $giangVien->MaGV }}" readonly>
                            </div>

                            {{-- Họ Đệm --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="HoDem"><span class="text-red-600">*</span>Họ đệm:</label>
                                <input class="form-input" type="text" id="HoDem" name="HoDem" value="{{ $giangVien->HoDem }}" readonly>
                            </div>
    
                            {{-- Tên --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="Ten"><span class="text-red-600">*</span>Tên:</label>
                                <input class="form-input" type="text" id="Ten" name="Ten" value="{{ $giangVien->Ten }}" readonly>
                            </div>
    
                            {{-- Tên Khác --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TenKhac"><span class="text-red-600">*</span>Tên khác:</label>
                                <input class="form-input" type="text" id="TenKhac" name="TenKhac" value="{{ $giangVien->TenKhac }}" readonly>
                            </div>

                            {{-- Giới Tính --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="GioiTinh"><span class="text-red-600">*</span>Giới tính:</label>
                                <input class="form-input input-view" type="text" id="GioiTinh" name="GioiTinh" value="{{ $giangVien->GioiTinh }}">
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input input-view" type="text" id="DanToc_ID" name="DanToc_ID" value="{{ $dantoc->TenDanToc }}">
                                <select class="form-input form-select-option select-edit" id="DanToc" name="DanToc_ID" required>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="date" id="NgaySinh" name="NgaySinh" value="{{ $giangVien->NgaySinh }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px" :messages="$errors->get('NgaySinh')" class="error-message" />        
                                </div>
                            </div>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="CCCD" name="CCCD" value="{{ $giangVien->CCCD }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px" :messages="$errors->get('CCCD')" class="error-message" />        
                                </div>
                            </div>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="NoiCapCCCD" name="NoiCapCCCD" value="{{ $giangVien->NoiCapCCCD }}" readonly>
                            </div>
    
                            {{-- Ngày Cấp CCCD --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NgayCapCCCD"><span class="text-red-600">*</span>Ngày cấp CCCD:</label>
                                <input class="form-input" type="date" id="NgayCapCCCD" name="NgayCapCCCD" value="{{ $giangVien->NgayCapCCCD }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px" :messages="$errors->get('NgayCapCCCD')" class="error-message" />        
                                </div>
                            </div>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="tel" id="SDT" name="SDT" value="{{ $giangVien->SDT }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px" :messages="$errors->get('SDT')" class="error-message" />        
                                </div>
                            </div>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="email" id="Email" name="Email" value="{{ $giangVien->Email }}" readonly>
                                <div style="height: 10px; width: 100%;"">
                                    <x-input-error style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px" :messages="$errors->get('Email')" class="error-message" />        
                                </div>
                            </div>
                            ...
                            <div class="per_form-group p-2">
                                ...
                                <input class="form-input" type="text" id="NoiSinh" name="NoiSinh" value="{{ $giangVien->NoiSinh }}" readonly>
                            </div>
    
                            {{-- Quê Quán --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="QueQuan"><span class="text-red-600">*</span>Quê quán:</label>
                                <input class="form-input" type="text" id="QueQuan" name="QueQuan" value="{{ $giangVien->QueQuan }}" readonly>
                            </div>
    
                            {{-- Địa Chỉ Thường trú --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="DiaChiThuongChu"><span class="text-red-600">*</span>Địa chỉ thường trú:</label>
                                <input class="form-input" type="text" id="DiaChiThuongChu" name="DiaChiThuongChu" value="{{ $giangVien->DiaChiThuongChu }}" readonly>
                            </div>
    
                            {{-- Chỗ Ở Hiện Nay --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="ChoOHienNay"><span class="text-red-600">*</span>Chỗ ở hiện nay:</label>
                                <input class="form-input" type="text" id="ChoOHienNay" name="ChoOHienNay" value="{{ $giangVien->ChoOHienNay }}" readonly>
                            </div>

                             <!-- SoBHXH -->
                             <div class="per_form-group p-1">
                                <label class="form-group__lable" for="SoBHXH"><span class="text-red-600">*</span>Số BHXH:</label>
                                <input class="form-input" type="text" id="SoBHXH" name="SoBHXH" value="{{ $giangVien->SoBHXH }}" readonly>
                            </div>

                            <!-- NgayTuyenDung -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NgayTuyenDung"><span class="text-red-600">*</span>Ngày tuyển dụng:</label>
                                <input class="form-input" type="date" id="NgayTuyenDung" name="NgayTuyenDung" value="{{ $giangVien->NgayTuyenDung }}" readonly>
                            </div>

                            <!-- TenNganHang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TenNganHang"><span class="text-red-600">*</span>Tên ngân hàng:</label>
                                <input class="form-input" type="text" id="TenNganHang" name="TenNganHang" value="{{ $giangVien->TenNganHang }}" readonly>
                            </div>

                            <!-- SoTaiKhoanNganHang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="SoTaiKhoanNganHang"><span class="text-red-600">*</span>Số tài khoản ngân hàng:</label>
                                <input class="form-input" type="text" id="SoTaiKhoanNganHang" name="SoTaiKhoanNganHang" value="{{ $giangVien->SoTaiKhoanNganHang }}" readonly>
                            </div>
                        </div>
                        {{-- Trình độ chuyên môn --}}
                        <div class="info-professional-level">
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="TrinhDo" name="TrinhDo" value="{{ $giangVien->TrinhDo }}" readonly>
                            </div>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="TrinhDoGiaoDucPhoThong" name="TrinhDoGiaoDucPhoThong" value="{{ $giangVien->TrinhDoGiaoDucPhoThong }}" readonly>
                            </div>
                            <!-- TrinhDoNgoaiNgu -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TrinhDoNgoaiNgu"><span class="text-red-600">*</span>Trình độ ngoại ngữ:</label>
                                <input class="form-input" type="text" id="TrinhDoNgoaiNgu" name="TrinhDoNgoaiNgu" value="{{ $giangVien->TrinhDoNgoaiNgu }}" readonly>
                            </div>
                            <!-- ChungChiKyNangNghe -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="ChungChiKyNangNghe"><span class="text-red-600">*</span>Chứng chỉ kỹ năng nghề:</label>
                                <input class="form-input" type="text" id="ChungChiKyNangNghe" name="ChungChiKyNangNghe" value="{{ $giangVien->ChungChiKyNangNghe }}" readonly>
                            </div>
                            <!-- ChuyenNganhHoc -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="ChuyenNganhHoc"><span class="text-red-600">*</span>Chuyên ngành học:</label>
                                <input class="form-input" type="text" id="ChuyenNganhHoc" name="ChuyenNganhHoc" value="{{ $giangVien->ChuyenNganhHoc }}" readonly>
                            </div>
                            <!-- CoSoDaoTao -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="CoSoDaoTao"><span class="text-red-600">*</span>Cơ sở đào tạo:</label>
                                <input class="form-input" type="text" id="CoSoDaoTao" name="CoSoDaoTao" value="{{ $giangVien->CoSoDaoTao }}" readonly>
                            </div>
                            <!-- NganhGiangDay -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="NganhGiangDay"><span class="text-red-600">*</span>Ngành giảng dạy:</label>
                                <input class="form-input input-view" type="text" id="NganhGiangDay" name="NganhGiangDay" value="{{ $nganh->TenNganh }}" readonly>
                                <select class="form-input form-select-option select-edit" id="nganh" name="Nganh_ID" required>
                                    <option value="{{ $nganh->TenNganh }}">{{ $nganh->TenNganh }}</option>
                                    @foreach ($danhsachNganh as $id => $tenNganh)
                                        <option value="{{ $id }}" {{ $giangVien->Nganh_ID == $id ? 'selected' : '' }}>
                                            {{ $tenNganh }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="ChungChiNghiepVuSuPham" name="ChungChiNghiepVuSuPham" value="{{ $giangVien->ChungChiNghiepVuSuPham }}" readonly>
                            </div>
                            <!-- KinhNghiemLamViec -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="KinhNghiemLamViec"><span class="text-red-600">*</span>Kinh nghiệm làm việc:</label>
                                <input class="form-input" type="text" id="KinhNghiemLamViec" name="KinhNghiemLamViec" value="{{ $giangVien->KinhNghiemLV }}" readonly>
                            </div>
                        </div>
                        {{-- Tình trạng sức khỏe --}}
                        <div class="info-health-condition">
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <input class="form-input" type="text" id="TinhTrangSucKhoe" name="TinhTrangSucKhoe" value="{{ $giangVien->TinhTrangSucKhoe }}" readonly>
                            </div>
                            <!-- ChieuCao -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="ChieuCao"><span class="text-red-600">*</span>Chiều cao (cm):</label>
                                <input class="form-input" type="text" id="ChieuCao" name="ChieuCao" value="{{ $giangVien->ChieuCao }}" readonly>
                            </div>
                            <!-- CanNang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="CanNang"><span class="text-red-600">*</span>Cân nặng (kg):</label>
                                <input class="form-input" type="text" id="CanNang" name="CanNang" value="{{ $giangVien->CanNang }}" readonly>
                            </div>
                            <!-- NhomMau -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NhomMau"><span class="text-red-600">*</span>Nhóm máu:</label>
                                <input class="form-input" type="text" id="NhomMau" name="NhomMau" value="{{ $giangVien->NhomMau }}" readonly>
                            </div>
                        </div>
