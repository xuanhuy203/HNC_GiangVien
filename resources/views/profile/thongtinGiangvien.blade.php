...
@section('content')
    ...
    <div class="grid container">
        <div class="row">
            <div class="col l-12">
                <h2 id="title" style="text-align: center; text-transform: uppercase">Thông Tin Giảng Viên</h2>
            </div>
        </div>
            ...
            <div class="col l-3" style="background-color:#eeeeffb8">
                <div class="avatar" style="display: flex; justify-content: center; align-item: center; padding-top: 16px">
                    ...
                    @if ($giangVien->HinhAnh)
                        <img src="{{ asset('storage/' . $giangVien->HinhAnh) }}" alt="Profile Picture" id="imagePreview"
                            style="width: 240px; border-radius: 50%; height: 240px; border: 2px solid #ccc">
                    @else
                        <img src="{{ asset('asset/images/df-avt.jpg') }}" alt="Profile Picture" id="imagePreview"
                            style="width: 240px; border-radius: 50%; height: 240px; border: 2px solid #ccc">
                    @endif
                </div>
                ...
                <div class="vcard-name" style="display:flex; justify-content: center; padding: 16px 0">
                    <div style="text-align: center">
                        <div style="font-size: 20px; line-height: 1.25; color: #1f2328; font-weight: 500">
                            {{ $giangVien->HoDem . ' ' . $giangVien->Ten }}</div>
                        <div style="font-size: 20px; line-height: 22px; color: #636c76; font-weight: 300; margin: 10px 0;">
                            {{ $giangVien->MaGV }}</div>
                        <div
                            style="font-size: 20px; line-height: 1.25; color: #1f2328; font-weight: 500; text-transform: capitalize">
                            {{ $nganh->TenNganh }}</div>
                    </div>
                </div>
                ...
                <form action="{{ route('profile.uploadAvatar') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <input class="form-input" class="btn" type="file" name="file" accept="image/*" id="uploadInput"
                        style="display: none;">
                    <button style="display: none" type="button" class="btn btn--primary" id="btnUploadAvatar">Thay đổi ảnh
                        đại diện</button>
                </form>
                {{-- Thành tựu đạt được --}}
                            ...
                            <g>
                                <g data-name="Layer 3">
                                    ...
                                    <path fill="#43a047"
                                        ...
                                        opacity="1" data-original="#43a047"></path>
                                    <path fill="#fff59d"
                                        d="M35.433 25.06H35v-8.217a1 1 0 0 0-1-1h-3.815a1 1 0 0 0-.855.483 5.84 5.84 0 0 1-1.63 1.752l-.53.374a1 1 0 0 0 .608 1.817l2.095-.1V25.1l-.381.016a1.814 1.814 0 0 0-1.781 1.824v2.485a1 1 0 0 0 1 1h7.551a1 1 0 0 0 1-1v-2.54a1.827 1.827 0 0 0-1.829-1.825z"
                                        opacity="1" data-original="#fff59d"></path>
                                </g>
                            </g>
                        </svg>
                    </div>
                    ...
                    <form action="{{ route('profilegiangvien.update') }}" method="POST">
                        ...
                        <div class="info-common">
                            ...
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="MaGV"><span class="text-red-600">*</span>Mã
                                    Giảng Viên:</label>
                                <input class="form-input input--not-edit" style = "color:red" type="text"
                                    id="maGV" name="MaGV" value="{{ $giangVien->MaGV }}" readonly>
                            </div>

                            {{-- Họ Đệm --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="HoDem"><span class="text-red-600">*</span>Họ
                                    đệm:</label>
                                <input class="form-input" type="text" id="HoDem" name="HoDem"
                                    value="{{ $giangVien->HoDem }}" readonly>
                            </div>

                            {{-- Tên --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="Ten"><span
                                        class="text-red-600">*</span>Tên:</label>
                                <input class="form-input" type="text" id="Ten" name="Ten"
                                    value="{{ $giangVien->Ten }}" readonly>
                            </div>

                            {{-- Tên Khác --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TenKhac"><span class="text-red-600">*</span>Tên
                                    khác:</label>
                                <input class="form-input" type="text" id="TenKhac" name="TenKhac"
                                    value="{{ $giangVien->TenKhac }}" readonly>
                            </div>

                            {{-- Giới Tính --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="GioiTinh"><span class="text-red-600">*</span>Giới
                                    tính:</label>
                                <input class="form-input input-view" type="text" id="GioiTinh" name="GioiTinh"
                                    value="{{ $giangVien->GioiTinh }}">
                                <select class="form-input form-select-option select-edit" id="GioiTinh" name="GioiTinh">
                                    <option value="Nam" {{ $giangVien->GioiTinh == 'Nam' ? 'selected' : '' }}>Nam
                                    </option>
                                    <option value="Nữ" {{ $giangVien->GioiTinh == 'Nữ' ? 'selected' : '' }}>Nữ
                                    </option>
                                </select>
                            </div>
                            ...
                            {{-- Dân Tộc --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="DanToc_ID"><span class="text-red-600">*</span>Dân
                                    tộc:</label>
                                <input class="form-input input-view" type="text" id="DanToc_ID" name="DanToc_ID"
                                    value="{{ $dantoc->TenDanToc }}">
                                <select class="form-input form-select-option select-edit" id="DanToc" name="DanToc_ID"
                                    required>
                                    @foreach ($danhsachDanToc as $id => $tenDanToc)
                                        <option value="{{ $id }}" {{ $dantoc->id == $id ? 'selected' : '' }}>
                                            {{ $tenDanToc }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            {{-- Ngày Sinh --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NgaySinh"><span class="text-red-600">*</span>Ngày
                                    sinh:</label>
                                <input class="form-input" type="date" id="NgaySinh" name="NgaySinh"
                                    value="{{ $giangVien->NgaySinh }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error
                                        style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px"
                                        :messages="$errors->get('NgaySinh')" class="error-message" />
                                </div>
                            </div>

                            {{-- CCCD --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="CCCD"><span
                                        class="text-red-600">*</span>CCCD:</label>
                                <input class="form-input" type="text" id="CCCD" name="CCCD"
                                    value="{{ $giangVien->CCCD }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error
                                        style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px"
                                        :messages="$errors->get('CCCD')" class="error-message" />
                                </div>
                            </div>

                            {{-- Nơi Cấp CCCD --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NoiCapCCCD"><span class="text-red-600">*</span>Nơi
                                    cấp CCCD:</label>
                                <input class="form-input" type="text" id="NoiCapCCCD" name="NoiCapCCCD"
                                    value="{{ $giangVien->NoiCapCCCD }}" readonly>
                            </div>

                            {{-- Ngày Cấp CCCD --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NgayCapCCCD"><span
                                        class="text-red-600">*</span>Ngày cấp CCCD:</label>
                                <input class="form-input" type="date" id="NgayCapCCCD" name="NgayCapCCCD"
                                    value="{{ $giangVien->NgayCapCCCD }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error
                                        style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px"
                                        :messages="$errors->get('NgayCapCCCD')" class="error-message" />
                                </div>
                            </div>

                            {{-- Số Điện Thoại --}}
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="SDT"><span class="text-red-600">*</span>Số
                                    điện thoại:</label>
                                <input class="form-input" type="tel" id="SDT" name="SDT"
                                    value="{{ $giangVien->SDT }}" readonly>
                                <div style="height: 10px; width: 100%; position: relative">
                                    <x-input-error
                                        style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px"
                                        :messages="$errors->get('SDT')" class="error-message" />
                                </div>
                            </div>

                            <!-- Email -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="Email"><span
                                        class="text-red-600">*</span>Email:</label>
                                <input class="form-input" type="email" id="Email" name="Email"
                                    value="{{ $giangVien->Email }}" readonly>
                                <div style="height: 10px; width: 100%;"">
                                    <x-input-error
                                        style="font-size: 12px; font-weight: 500; color: red!important; margin-left: 5px"
                                        :messages="$errors->get('Email')" class="error-message" />
                                </div>
                            </div>

                            {{-- Nơi Sinh --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="NoiSinh"><span class="text-red-600">*</span>Nơi
                                    sinh:</label>
                                <input class="form-input" type="text" id="NoiSinh" name="NoiSinh"
                                    value="{{ $giangVien->NoiSinh }}" readonly>
                            </div>

                            {{-- Quê Quán --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="QueQuan"><span class="text-red-600">*</span>Quê
                                    quán:</label>
                                <input class="form-input" type="text" id="QueQuan" name="QueQuan"
                                    value="{{ $giangVien->QueQuan }}" readonly>
                            </div>

                            {{-- Địa Chỉ Thường trú --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="DiaChiThuongChu"><span
                                        class="text-red-600">*</span>Địa chỉ thường trú:</label>
                                <input class="form-input" type="text" id="DiaChiThuongChu" name="DiaChiThuongChu"
                                    value="{{ $giangVien->DiaChiThuongChu }}" readonly>
                            </div>

                            {{-- Chỗ Ở Hiện Nay --}}
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="ChoOHienNay"><span class="text-red-600">*</span>Chỗ
                                    ở hiện nay:</label>
                                <input class="form-input" type="text" id="ChoOHienNay" name="ChoOHienNay"
                                    value="{{ $giangVien->ChoOHienNay }}" readonly>
                            </div>

                            <!-- SoBHXH -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="SoBHXH"><span class="text-red-600">*</span>Số
                                    BHXH:</label>
                                <input class="form-input" type="text" id="SoBHXH" name="SoBHXH"
                                    value="{{ $giangVien->SoBHXH }}" readonly>
                            </div>

                            <!-- NgayTuyenDung -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NgayTuyenDung"><span
                                        class="text-red-600">*</span>Ngày tuyển dụng:</label>
                                <input class="form-input" type="date" id="NgayTuyenDung" name="NgayTuyenDung"
                                    value="{{ $giangVien->NgayTuyenDung }}" readonly>
                            </div>

                            <!-- TenNganHang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TenNganHang"><span class="text-red-600">*</span>Tên
                                    ngân hàng:</label>
                                <input class="form-input" type="text" id="TenNganHang" name="TenNganHang"
                                    value="{{ $giangVien->TenNganHang }}" readonly>
                            </div>

                            <!-- SoTaiKhoanNganHang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="SoTaiKhoanNganHang"><span
                                        class="text-red-600">*</span>Số tài khoản ngân hàng:</label>
                                <input class="form-input" type="text" id="SoTaiKhoanNganHang"
                                    name="SoTaiKhoanNganHang" value="{{ $giangVien->SoTaiKhoanNganHang }}" readonly>
                            </div>
                        </div>
                        {{-- Trình độ chuyên môn --}}
                        <div class="info-professional-level">
                            <div class="form__title p-4">
                                <svg style="display: flex;" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="29" height="29" x="0" y="0"
                                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"
                                    class="">
                                    <g>
                                        <path
                                            d="m506.62 141.44-248-86c-1.7-.59-3.54-.59-5.24 0l-248 86C2.16 142.56 0 145.59 0 149s2.16 6.44 5.38 7.56L80 182.44v103.83h.01c.21 15.31 18.81 27.59 55.3 36.5C167.64 330.65 210.5 335 256 335c38.05 0 74.25-3.04 104-8.65v36.03c-9.31 3.3-16 12.19-16 22.62a23.9 23.9 0 0 0 5.38 15.12c-5.75 5.13-9.38 12.59-9.38 20.88v28c0 4.42 3.58 8 8 8h40c4.42 0 8-3.58 8-8v-28c0-8.29-3.63-15.75-9.38-20.88 3.36-4.13 5.38-9.39 5.38-15.12 0-10.43-6.69-19.32-16-22.62v-39.45c.23-.06.46-.11.69-.16C413.39 313.81 432 301.44 432 286V182.44l74.62-25.88c3.22-1.12 5.38-4.15 5.38-7.56s-2.16-6.44-5.38-7.56zM380 441h-24v-20c0-6.62 5.38-12 12-12s12 5.38 12 12zm-20-56c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8-8-3.59-8-8zm-104-66c-44.25 0-85.77-4.18-116.9-11.78C103.74 298.59 96 288.98 96 286v-98.02l157.38 54.57c.85.29 1.74.44 2.62.44s1.77-.15 2.62-.44L360 207.4v102.65c-29.28 5.8-65.61 8.95-104 8.95zm160-33c0 2.89-7.29 12.02-40 20.44V201.85l40-13.87zm-43.33-99.92c-.5-.36-1.04-.69-1.63-.93l-116-47.55c-4.09-1.68-8.76.28-10.44 4.37s.28 8.76 4.37 10.44l101.19 41.48L256 226.53 32.42 149 256 71.47 479.58 149z"
                                            fill="#000000" opacity="1" data-original="#000000" class=""></path>
                                    </g>
                                </svg>
                                Trình độ chuyên môn
                            ...
                            <!-- TrinhDo -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TrinhDo"><span class="text-red-600">*</span>Trình
                                    độ:</label>
                                <input class="form-input" type="text" id="TrinhDo" name="TrinhDo"
                                    value="{{ $giangVien->TrinhDo }}" readonly>
                            </div>
                            <!-- TrinhDoGiaoDucPhoThong -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TrinhDoGiaoDucPhoThong"><span
                                        class="text-red-600">*</span>Trình độ giáo dục phổ thông:</label>
                                <input class="form-input" type="text" id="TrinhDoGiaoDucPhoThong"
                                    name="TrinhDoGiaoDucPhoThong" value="{{ $giangVien->TrinhDoGiaoDucPhoThong }}"
                                    readonly>
                            </div>
                            <!-- TrinhDoNgoaiNgu -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TrinhDoNgoaiNgu"><span
                                        class="text-red-600">*</span>Trình độ ngoại ngữ:</label>
                                <input class="form-input" type="text" id="TrinhDoNgoaiNgu" name="TrinhDoNgoaiNgu"
                                    value="{{ $giangVien->TrinhDoNgoaiNgu }}" readonly>
                            </div>
                            <!-- ChungChiKyNangNghe -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="ChungChiKyNangNghe"><span
                                        class="text-red-600">*</span>Chứng chỉ kỹ năng nghề:</label>
                                <input class="form-input" type="text" id="ChungChiKyNangNghe"
                                    name="ChungChiKyNangNghe" value="{{ $giangVien->ChungChiKyNangNghe }}" readonly>
                            </div>
                            <!-- ChuyenNganhHoc -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="ChuyenNganhHoc"><span
                                        class="text-red-600">*</span>Chuyên ngành học:</label>
                                <input class="form-input" type="text" id="ChuyenNganhHoc" name="ChuyenNganhHoc"
                                    value="{{ $giangVien->ChuyenNganhHoc }}" readonly>
                            </div>
                            <!-- CoSoDaoTao -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="CoSoDaoTao"><span class="text-red-600">*</span>Cơ
                                    sở đào tạo:</label>
                                <input class="form-input" type="text" id="CoSoDaoTao" name="CoSoDaoTao"
                                    value="{{ $giangVien->CoSoDaoTao }}" readonly>
                            </div>
                            <!-- NganhGiangDay -->
                            <div class="per_form-group p-2">
                                <label class="form-group__lable" for="NganhGiangDay"><span
                                        class="text-red-600">*</span>Ngành giảng dạy:</label>
                                <input class="form-input input-view" type="text" id="NganhGiangDay"
                                    name="NganhGiangDay" value="{{ $nganh->TenNganh }}" readonly>
                                <select class="form-input form-select-option select-edit" id="nganh" name="Nganh_ID"
                                    required>
                                    <option value="{{ $nganh->TenNganh }}">{{ $nganh->TenNganh }}</option>
                                    @foreach ($danhsachNganh as $id => $tenNganh)
                                        <option value="{{ $id }}"
                                            {{ $giangVien->Nganh_ID == $id ? 'selected' : '' }}>
                                            {{ $tenNganh }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="ChungChiNghiepVuSuPham"><span
                                        class="text-red-600">*</span>Chứng chỉ nghiệp vụ sư phạm:</label>
                                <input class="form-input" type="text" id="ChungChiNghiepVuSuPham"
                                    name="ChungChiNghiepVuSuPham" value="{{ $giangVien->ChungChiNghiepVuSuPham }}"
                                    readonly>
                            </div>
                            <!-- KinhNghiemLamViec -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="KinhNghiemLamViec"><span
                                        class="text-red-600">*</span>Kinh nghiệm làm việc:</label>
                                <input class="form-input" type="text" id="KinhNghiemLamViec" name="KinhNghiemLamViec"
                                    value="{{ $giangVien->KinhNghiemLV }}" readonly>
                            </div>
                        </div>
                        {{-- Tình trạng sức khỏe --}}
                        <div class="info-health-condition">
                            ...
                            <!-- TinhTrangSucKhoe -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="TinhTrangSucKhoe"><span
                                        class="text-red-600">*</span>Tình trạng sức khỏe:</label>
                                <input class="form-input" type="text" id="TinhTrangSucKhoe" name="TinhTrangSucKhoe"
                                    value="{{ $giangVien->TinhTrangSucKhoe }}" readonly>
                            </div>
                            <!-- ChieuCao -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="ChieuCao"><span class="text-red-600">*</span>Chiều
                                    cao (cm):</label>
                                <input class="form-input" type="text" id="ChieuCao" name="ChieuCao"
                                    value="{{ $giangVien->ChieuCao }}" readonly>
                            </div>
                            <!-- CanNang -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="CanNang"><span class="text-red-600">*</span>Cân
                                    nặng (kg):</label>
                                <input class="form-input" type="text" id="CanNang" name="CanNang"
                                    value="{{ $giangVien->CanNang }}" readonly>
                            </div>
                            <!-- NhomMau -->
                            <div class="per_form-group p-1">
                                <label class="form-group__lable" for="NhomMau"><span class="text-red-600">*</span>Nhóm
                                    máu:</label>
                                <input class="form-input" type="text" id="NhomMau" name="NhomMau"
                                    value="{{ $giangVien->NhomMau }}" readonly>
                            </div>
                        </div>

                        <div class="per_form-group p-4 content-end" style="padding: 20px 20px 40px 20px">
                            <button class="btn btn--primary" style="display: none" type="submit" id="btnSave">Lưu
                                thay đổi</button>
                        </div>
                    </form>
                </div>
