        ...
        <div class="row flex" style="padding-top: 15px">
            ...
            <div class="col l-9" style="padding-right: 0">
                ...
                <div class="view-edit-section form-container">
                    <form action="{{ route('profilegiangvien.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        {{-- Thông tin chung --}}
                            ...
                            <div class="per_form-group p-1">
                                ...
                                <select class="form-input form-select-option select-edit" id="DanToc" name="DanToc_ID" required>
                                    @foreach ($danhsachDanToc as $id => $tenDanToc)
                                        <option value="{{ $id }}" {{ $id == $giangVien->DanToc_ID ? 'selected' : '' }}>
                                            {{ $tenDanToc }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="info-professional-level">
                            ...
                            <div class="per_form-group p-2">
                                ...
                                <input class="form-input input-view" type="text" id="NganhGiangDay" name="NganhGiangDay" value="{{ $nganh->TenNganh }}">
                                <select class="form-input form-select-option select-edit" id="nganh" name="Nganh_ID" required>
                                    @foreach ($danhsachNganh as $id => $tenNganh)
                                        <option value="{{ $id }}" {{ $id == $giangVien->Nganh_ID ? 'selected' : '' }}>
                                            {{ $tenNganh }}
                                        </option>
                                    @endforeach
                                </select>
